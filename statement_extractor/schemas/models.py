...
class OCRToken(BaseModel):
    ...
    normalized_x1: float = 0.0 # x1 / page_width
    normalized_y1: float = 0.0 # y1 / page_height
    normalized_x2: float = 0.0 # x2 / page_width
    normalized_y2: float = 0.0 # y2 / page_height
    page_num: int = 0
...
class LogicalRow(BaseModel):
    ...
    is_anchor: bool = False         # True if this row contains date or amount
    merge_dir: str = 'up'           # Direction to merge continuation ('up' or 'down')
