...
class RowGroupingConfig:
    ...
    dbscan_eps_fraction: float = 0.006  # fraction of page height for DBSCAN eps
                                         # 0.006 ≈ 14px at 200 DPI/A4 — keeps individual
                                         # OCR text lines separate while joining tokens
                                         # that share the same visual row
